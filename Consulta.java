...
public class Consulta {
    ...
    // ✅ Atualiza o status diretamente no arquivo usando FileWriter
    public void atualizarStatusNoArquivo(StatusConsulta novoStatus) {
        ...
        try (FileWriter writer = new FileWriter(arquivo, false)) { // sobrescreve
            ...
            System.out.println("Erro ao escrever no arquivo da consulta.");
        }
    }
}

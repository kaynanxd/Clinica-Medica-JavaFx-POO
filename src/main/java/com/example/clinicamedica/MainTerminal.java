...
public class MainTerminal {
    ...
    private static void menuPaciente(UsuarioPaciente paciente) {
        ...
        do {
            ...
            System.out.println("6. Ver Boletos Pendentes");
            System.out.println("7. Pagar Boletos");
            System.out.println("0. Logout");
            opcao = InputGerenciador.lerInteiro("Escolha uma opção: ");
            ...
            switch (opcao) {
                ...
                case 6 -> {
                    ...
                    for (Boleto boleto : pendentes) {
                        System.out.println("--------------------------------");
                        System.out.println("Código: " + boleto.getCodigo());
                        System.out.println("Valor: R$" + String.format("%.2f", boleto.getValor()));
                        System.out.println("Vencimento: " + boleto.getDataVencimento().format(String.valueOf(formatoData)));
                        System.out.println("Médico: " + boleto.getNomeMedico());
                        System.out.println("Especialidade: " + boleto.getEspecialidade());
                        System.out.println("Status: " + (boleto.isPago() ? "PAGO" : "PENDENTE"));
                        System.out.println("--------------------------------\n");
                    }
                }
                case 7 -> {
                    ...
                    if (pendentes.isEmpty()) {
                        System.out.println("\nNão há boletos pendentes para pagamento.");
                        break;
                    }
                    ...
                    for (Boleto boleto : pendentes) {
                        System.out.println("Código: " + boleto.getCodigo() +
                                " | Valor: R$" + String.format("%.2f", boleto.getValor()) +
                                " | Vencimento: " + boleto.getDataVencimento().format(String.valueOf(DateTimeFormatter.ofPattern("dd/MM/yyyy"))));
                    }

                    String codigoBoleto = InputGerenciador.lerString("\nDigite o código do boleto: ");
                    Boleto boletoSelecionado = GerenciadorBoletos.buscarBoleto(codigoBoleto, paciente.getId());

                    if (boletoSelecionado == null) {
                        System.out.println("Boleto inválido ou não pertence a você");

                        break;
                    }
                        GerenciadorBoletos.marcarComoPago(codigoBoleto);
                        System.out.println("Pagamento confirmado! Boleto marcado como PAGO.");
                }
                case 0 -> System.out.println("Logout realizado.");
                default -> System.out.println("Opção inválida.");
            }
